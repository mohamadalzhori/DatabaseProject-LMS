...
function PointsDashboard() {
  ...
  const handleSubmit = (event) => {
    ...
    axios.put(`http://localhost:3001/authStudents`, data)
      .then((response) => {
      ...
      <Form onSubmit={handleSubmit}>
            <Row>
              ...
              <Col>
                    ...
                    <Form.Control required placeholder="Enter a value to overwrite the current one" value={points} onChange={(e)=>{setPoints(e.target.value)}} />
                        </Form.Group>    
              </Col>
            </Row>
